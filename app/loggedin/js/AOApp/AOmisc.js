function getTerm(expiration) {
	var year = Number('20'+ expiration.substring(0, 2));
	var month = Number(expiration.substring(2, 4))-1;
	var day = Number(expiration.substring(4, expiration.length));
